...
OGL2DTextDisplay::OGL2DTextDisplay( float charWidth, float charHeight ) : OGLGameObject( "OGL2DTextDisplay" )
{
...
{
	// Create new TextXY instance with position data
...
void OGL2DTextDisplay::renderChar( char ch, float x, float y )
{
	...
	pos.lx = x;
	pos.ty = y;
	pos.rx = pos.lx + this->charWidth;
	pos.by = pos.ty - this->charHeight;
