...
public:
	...
	virtual void loadShaders( const std::string& shaderAssetFilename );

	virtual void initializeWindowAndGraphics( const std::string& uniformAssetFilename );

	virtual void setupGraphicsParameters( const std::string& uniformAssetFilename );

	virtual void setupGame( const std::string& gameAssetsFilename = "" );
