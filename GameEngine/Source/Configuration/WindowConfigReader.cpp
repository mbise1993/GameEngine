...
void WindowConfigReader::readConfigFile(WindowInfo& windowInfo)
{
	...
	windowInfo.backgroundColor.red = this->readAttribute<int>("background-color-red");
	windowInfo.backgroundColor.green = this->readAttribute<int>("background-color-green");
	windowInfo.backgroundColor.blue = this->readAttribute<int>("background-color-blue");
	windowInfo.backgroundColor.alpha = this->readAttribute<int>("background-color-alpha");
}