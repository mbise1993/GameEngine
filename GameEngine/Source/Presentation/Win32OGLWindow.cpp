...
Win32OGLWindow::Win32OGLWindow(WindowInfo& windowInfo):
	Win32Window(windowInfo.title, windowInfo.width, windowInfo.height)
{
	this->renderingContext = NULL;
	this->deviceContext = NULL;
	this->WndProcedure = Win32OGLWindow::WndProc;
	this->self = this;
	this->background = windowInfo.backgroundColor;
}
